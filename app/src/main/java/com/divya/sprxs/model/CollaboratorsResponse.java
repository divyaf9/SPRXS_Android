...
public class CollaboratorsResponse {
    ...
    public CollaboratorsResponse(int id, String ideaId, String ownerProfile, int lkpWoiRole, int lkpWoiCapacity, int lkpWoiRemun, String collabReason, String collabValueadd, String collabFilepath, String bxnTxnId, Boolean emailSent, int collabApproved, Long dateCreated, String firstname, String lastname, Long profileId, String collaboratorFirebaseUid, String error) {
        this.id = id;
        this.ideaId = ideaId;
